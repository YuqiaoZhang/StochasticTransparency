...
struct DXUTD3D10DeviceSettings
{
	...
	// Iain: NV-specific modification.
	// DXUT will *NOT* try to create a 10.1 device first, then 10.0.  The sense is negated so that
	// init'ing this struct with ZeroMemory will default to using a 10.1 device.
	bool AvoidDX10_1;				
};
